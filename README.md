...
1. [`with-local-storage`]() ([Demo]()): The canvas dataset is stored in the browser localstorage. 
...
1. [`with-faunadb-auth`](https://github.com/Vadorequest/poc-nextjs-reaflow/pull/12) ([Demo](https://poc-nextjs-reaflow-git-with-faunadb-auth-ambroise-dhenain.vercel.app/)): The canvas dataset is stored in FaunaDB. 
